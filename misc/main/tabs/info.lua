...
function misctabs:AddMiscTab(Tab)
    local GroupCredits = Tab:AddLeftGroupbox(api:getTranslate("tab_Credits", "Desenvolvedores"))
    local GroupContributors = Tab:AddLeftGroupbox(api:getTranslate("tab_Credits_Contributors", "Contribuidores"))
    local GroupTranslators = Tab:AddRightGroupbox(api:getTranslate("tab_Credits_Translators", "Tradutores"))
