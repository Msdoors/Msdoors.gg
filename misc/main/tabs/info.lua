...
function misctabs:AddMiscTab(Tab)
    ...
    local EspecialCreditsGeirge = GroupContributors:AddLabel('<font color="rgb(138, 43, 226)">[George]</font> | It helped me with Anti Water Electrified and continues to help me with more resources and tips. ', true)
    local EspecialCreditsCoookis = GroupContributors:AddLabel('<font color="rgb(138, 43, 226)">[CookieMonster]</font> | He helped me with the anti-Mandrake and always helps me when needed.', true)
